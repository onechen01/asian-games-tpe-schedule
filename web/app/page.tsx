...
function Card({row,conflict,pending,master,names:display,shows=[],advance}:{row:Row;conflict:boolean;pending?:boolean;master:AthleteMaster;names:DisplayNames;shows?:Broadcast[];advance?:{stage:string;nextDate:string;nextTimeTaipei:string|null;nextTimeNote?:{code:'FOLLOWED_BY'|'NOT_BEFORE'|'RESCHEDULED'|'PENDING';clockTaipei:string|null;raw:string|null}|null}|null}){
